...
namespace System.Data.Entity.Core.Common.CommandTrees.ExpressionBuilder.Hierarchy
{
    ...
    /// <summary>
    ///     Provides an API to construct <see cref="DbExpression" />s that invoke hierarchyid realted canonical EDM functions, and, where appropriate, allows that API to be accessed as extension methods on the expression type itself.
    /// </summary>
